...
(async () => {
  ...
  // Force production mode when NODE_ENV is production OR when not in development
  const isProduction = process.env.NODE_ENV === "production" || app.get("env") !== "development";
